  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <h2 className="text-xl font-bold text-slate-800 dark:text-slate-100 flex items-center gap-2">
            <Landmark className="w-5 h-5 text-amber-600 dark:text-amber-400" /> Debt, CIBIL Credit Health & Bank EMI Engine
          </h2>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="glass-panel p-6 rounded-3xl border border-slate-200 dark:border-slate-800 bg-gradient-to-br from-white via-indigo-50/30 to-purple-50/30 dark:from-slate-900 dark:to-indigo-950/40">
          <div className="flex items-center justify-between mb-3">
            ...
            <span className="px-2.5 py-0.5 rounded-full bg-emerald-100 dark:bg-emerald-950 border border-emerald-300 dark:border-emerald-700 text-emerald-700 dark:text-emerald-300 text-[10px] font-extrabold uppercase">
              {cibilRating}
            </span>
          </div>
          ...
          <div className="text-center py-3">
            ...
            {/* Score Visual Bar */}
            <div className="w-full bg-slate-200 dark:bg-slate-800 h-3 rounded-full overflow-hidden mt-3 mb-2 p-0.5">
              <div
                className="h-full rounded-full bg-gradient-to-r from-amber-500 via-emerald-500 to-indigo-600 transition-all duration-700"
                style={{ width: `${(cibilScore / 900) * 100}%` }}
              />
            </div>
            <p className="text-[11px] text-slate-500 dark:text-slate-400">
              Calculated via payment history, debt ratio, and credit mix. You qualify for <span className="text-emerald-600 dark:text-emerald-400 font-bold">Pre-Approved Lowest Rates</span>.
            </p>
          </div>
        </div>
        ...
        <div className="lg:col-span-2 glass-panel p-6 rounded-3xl border border-slate-200 dark:border-slate-800 flex flex-col justify-between">
          <div>
            <div className="flex items-center justify-between mb-3">
              <h3 className="text-sm font-bold text-slate-800 dark:text-slate-100 flex items-center gap-2">
                <Building2 className="w-4 h-4 text-indigo-600 dark:text-indigo-400" /> Connected Open Banking API Servers
              </h3>
              <span className="px-2.5 py-1 rounded-xl bg-emerald-50 dark:bg-emerald-950/80 text-emerald-700 dark:text-emerald-300 border border-emerald-200 dark:border-emerald-800 text-[11px] font-semibold flex items-center gap-1">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 my-2">
              <div className="p-3 rounded-2xl bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-800 text-center">
                ...
                <div className="text-xs font-bold text-slate-700 dark:text-slate-300 mt-1">HDFC Bank</div>
                <div className="text-[10px] text-emerald-600 dark:text-emerald-400 font-medium">Synced</div>
              </div>
              <div className="p-3 rounded-2xl bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-800 text-center">
                <div className="text-lg">🏛️</div>
                <div className="text-xs font-bold text-slate-700 dark:text-slate-300 mt-1">State Bank of India</div>
                <div className="text-[10px] text-emerald-600 dark:text-emerald-400 font-medium">Synced</div>
              </div>
              <div className="p-3 rounded-2xl bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-800 text-center">
                <div className="text-lg">🏢</div>
                <div className="text-xs font-bold text-slate-700 dark:text-slate-300 mt-1">ICICI Bank</div>
                <div className="text-[10px] text-emerald-600 dark:text-emerald-400 font-medium">Synced</div>
              </div>
              <div className="p-3 rounded-2xl bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-800 text-center">
                <div className="text-lg">🏪</div>
                <div className="text-xs font-bold text-slate-700 dark:text-slate-300 mt-1">Axis Bank</div>
                <div className="text-[10px] text-emerald-600 dark:text-emerald-400 font-medium">Synced</div>
              </div>
            </div>
          </div>
          ...
          <div className="text-[11px] text-slate-500 dark:text-slate-400 pt-2 border-t border-slate-100 dark:border-slate-800 flex justify-between items-center">
            <span>Loan Capacity Limit: <strong className="text-slate-700 dark:text-slate-200">{formatCurrency(3500000, currency)}</strong></span>
            <span>FOIR Ratio: <strong className="text-emerald-600 dark:text-emerald-400">12.7% (Healthy)</strong></span>
          </div>
        </div>
      </div>
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          <div>
            <h3 className="text-base font-bold text-slate-800 dark:text-slate-100 flex items-center gap-2">
              <Calculator className="w-5 h-5 text-indigo-600 dark:text-indigo-400" /> Best Bank EMI Options & Loan Eligibility Finder
            </h3>
            <p className="text-xs text-slate-500 dark:text-slate-400 mt-0.5">
          ...
          <form onSubmit={handleCalculateEmiOptions} className="flex flex-wrap items-center gap-3">
            <div>
              <label className="block text-[10px] font-semibold text-slate-500 dark:text-slate-400 mb-0.5">Loan Category</label>
              <select
            ...
            <div>
              <label className="block text-[10px] font-semibold text-slate-500 dark:text-slate-400 mb-0.5">Required Amount ({currency})</label>
              <input
                type="number"
                placeholder="500000"
            ...
            <div>
              <label className="block text-[10px] font-semibold text-slate-500 dark:text-slate-400 mb-0.5">Tenure (Months)</label>
              <select
                value={desiredTenure}
          ...
          {offers.map((offer, idx) => (
            <div
              ...
              className={`glass-card p-5 rounded-2xl space-y-3 relative flex flex-col justify-between border ${
                offer.preApproved
                  ? 'border-indigo-200 dark:border-indigo-900 bg-gradient-to-b from-indigo-50/20 to-transparent'
            ...
            >
              <div>
                <div className="flex items-center justify-between mb-2">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="font-bold text-xs text-slate-800 dark:text-slate-100">{offer.bankName}</span>
                  </div>
                  {offer.preApproved && (
                    <span className="px-2 py-0.5 rounded bg-emerald-100 dark:bg-emerald-950 text-emerald-700 dark:text-emerald-300 text-[9px] font-extrabold uppercase border border-emerald-200 dark:border-emerald-800">
                      Pre-Approved
                    </span>
                  )}
                </div>

                <div className="my-3 text-center py-2 bg-slate-50 dark:bg-slate-900 rounded-xl border border-slate-100 dark:border-slate-800">
                ...
                <div className="space-y-1 text-[11px] text-slate-600 dark:text-slate-400">
                  <div className="flex justify-between">
                    ...
                    <span className="font-semibold text-emerald-600 dark:text-emerald-400">{offer.processingFee}</span>
                  </div>
                </div>

                <ul className="mt-3 pt-2 border-t border-slate-100 dark:border-slate-800 space-y-1 text-[10px] text-slate-500 dark:text-slate-400">
              ...
              <button
                ...
                className="w-full mt-3 py-2 rounded-xl bg-slate-900 dark:bg-slate-100 hover:bg-slate-800 dark:hover:bg-white text-white dark:text-slate-900 text-xs font-bold transition shadow-sm"
              >
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        <div className="glass-card p-5 rounded-2xl">
          <span className="text-xs text-slate-500 dark:text-slate-400 font-medium">Total Outstanding Debt</span>
        ...
        <div className="glass-card p-5 rounded-2xl">
          <span className="text-xs text-slate-500 dark:text-slate-400 font-medium">Active Loan Facilities</span>
          ...
          return (
            <div key={loan.id} className="glass-card p-6 rounded-3xl space-y-4">
              <div className="flex items-center justify-between">
                <div>
                  <h3 className="text-base font-bold text-slate-800 dark:text-slate-100">{loan.name}</h3>
                  <span className="text-xs text-amber-600 dark:text-amber-400 font-semibold">{loan.type}</span>
                </div>
                <span className="px-2.5 py-1 rounded-lg bg-amber-50 dark:bg-amber-950/80 border border-amber-200 dark:border-amber-800 text-amber-700 dark:text-amber-300 font-semibold text-xs flex items-center gap-1">
              ...
              <div className="space-y-1">
                <div className="flex justify-between text-xs">
                  <span className="text-slate-500 dark:text-slate-400">Principal Repaid ({paidPercentage}%)</span>
                  <span className="text-slate-700 dark:text-slate-200 font-bold">{formatCurrency(paidAmount, currency)}</span>
                </div>
                <div className="w-full bg-slate-100 dark:bg-slate-800 h-2.5 rounded-full overflow-hidden border border-slate-200 dark:border-slate-800">
                  <div
              ...
              <div className="grid grid-cols-3 gap-2 pt-2 border-t border-slate-100 dark:border-slate-800 text-xs text-center">
                <div>
                  <span className="text-[10px] text-slate-400">Outstanding</span>
                  <div className="font-bold text-rose-600 dark:text-rose-400">{formatCurrency(loan.outstandingAmount, currency)}</div>
                </div>
                <div>
                  <span className="text-[10px] text-slate-400">Monthly EMI</span>
                  <div className="font-bold text-slate-800 dark:text-slate-100">{formatCurrency(loan.emiAmount, currency)}</div>
                </div>
                <div>
                  <span className="text-[10px] text-slate-400">Remaining</span>
                  <div className="font-bold text-slate-600 dark:text-slate-300">{loan.remainingMonths} Months</div>
                </div>
              </div>
      ...
      {isModalOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/30 backdrop-blur-sm p-4">
          <div className="w-full max-w-md bg-white dark:bg-slate-900 rounded-3xl p-6 border border-slate-200 dark:border-slate-800 shadow-xl">
            <h3 className="text-lg font-bold text-slate-800 dark:text-slate-100 mb-4">Add Loan Facility</h3>
            <form onSubmit={handleCreateLoan} className="space-y-4">
              <div>
                <label className="block text-xs font-semibold text-slate-600 dark:text-slate-300 mb-1">Loan Title</label>
                <input
                  type="text"
              ...
              <div>
                <label className="block text-xs font-semibold text-slate-600 dark:text-slate-300 mb-1">Loan Type</label>
                <select
                  value={type}
              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  <label className="block text-xs font-semibold text-slate-600 dark:text-slate-300 mb-1">Total Loan Amount</label>
                  <input
                    type="number"
                ...
                <div>
                  <label className="block text-xs font-semibold text-slate-600 dark:text-slate-300 mb-1">Outstanding Principal</label>
                  <input
                    type="number"
              ...
              <div className="grid grid-cols-3 gap-3">
                <div>
                  <label className="block text-xs font-semibold text-slate-600 dark:text-slate-300 mb-1">Interest Rate %</label>
                  <input
                    type="number"
                    step="0.1"
                    placeholder="8.5"
                ...
                <div>
                  <label className="block text-xs font-semibold text-slate-600 dark:text-slate-300 mb-1">Monthly EMI</label>
                  <input
                    type="number"
                    placeholder="18500"
                    value={emiAmount}
                ...
                <div>
                  <label className="block text-xs font-semibold text-slate-600 dark:text-slate-300 mb-1">Months Left</label>
                  <input
                    type="number"
                    placeholder="36"
              ...
              <div className="flex gap-3 pt-2">
                <button
                  ...
                  className="flex-1 py-2.5 rounded-xl bg-slate-100 dark:bg-slate-800 text-slate-600 dark:text-slate-300 text-xs font-semibold"
                >
                  Cancel
                </button>
                <button
